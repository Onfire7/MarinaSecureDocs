-- PROTOTYPE — throwaway. Seeds the LOCAL database with a realistic closed
-- status audit and a finalized occupancy audit so the report variants have
-- real density to be judged against. Never run against a marina's database.
